...
public class InventoryPanel extends JPanel {
    ...
    /**
     * VuMeterPanel is used here exactly as Module 6 left it, EXCEPT for
     * one constructor argument: it's now driven by NativeSignalGenerator
     * (Module 9's real, JNI-backed system load reading) instead of the
     * decorative SignalGenerator. This is the entire integration effort -
     * confirmation that LevelSource's decoupling actually worked as
     * intended, three chapters after it was first promised.
     */
    private JPanel buildActivityPanel() {
        JPanel panel = new JPanel(new BorderLayout());
        panel.setBorder(BorderFactory.createTitledBorder("Activity (live system load)"));
        panel.add(new VuMeterPanel(new NativeSignalGenerator()), BorderLayout.CENTER);
        return panel;
    }
